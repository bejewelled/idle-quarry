export default class ref {
    ...
    static tabNotUnlockedText = {
        ...
        augments: "Relocate once to unlock."
    };
    ...
    static miningUpgradeSortOrder = {
        ...
        "kleptomaniac": 21.4,
        'overload': 22,
        'cerium decomposition': 22.5,
        'excavator': 24,
        'fortune ii': 25,
        'isotopes': 26,
        'blinding lights': 27,
        'elusive minerals': 926,
        'ethereal box': 927,
        'phantom legend': 928,
        'negative mass': 950,
    ...
    static tutorialModeDescriptions = {
        ...
        crystals:
            "Gain crystals from random drops while mining, from keys, and from the reactor.",
        ...
        artifacts:
            "Very rarely gain artifacts from keys, the reactor, and random drops while mining. Artifacts unlock powerful passive bonuses.",
        mist: "Gain mist from mastery.",
        trophies: "Gain trophies from mastery.",
        dust: "Gain dust very rarely while mining.",
        radium: "Gain radium from clicking the reactor. Radium produces crystals.",
